...
-- Ikon resize (titik-titik diagonal)
local ResizeIcon = Instance.new("TextLabel", ResizeHandle)
ResizeIcon.Size = UDim2.new(1,0,1,0)
ResizeIcon.BackgroundTransparency = 1
ResizeIcon.Text = "⠿"
ResizeIcon.TextColor3 = Color3.fromRGB(160,160,160)
...
do
    ...
    local startPos    = Vector2.zero  -- posisi window saat mulai resize
    ...
    UserInputService.InputChanged:Connect(function(input)
        ...
        -- Update SIZE_NORMAL agar minimize/maximize pakai ukuran baru
        SIZE_NORMAL = UDim2.new(0, newW, 0, newH)
    end)
